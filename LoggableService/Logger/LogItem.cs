...
namespace Loggers
{
    ...
    {
        public string InitiatorMethod { get; private set; }
        ...
        internal LogHeader(string initiatorMethod)
        {
            InitiatorMethod = initiatorMethod;
        }

        public override string ToString()
        {
            //TODO: write a less lazy-ass ToString() implementation...
